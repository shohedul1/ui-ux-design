    ...
    <div className='flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px]'>
        <div className='flex flex-col gap-x-6 sm:flex-row-reverse'>
            ...
            <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
                ...
                <p className='py-[24px] text-[#36485C] lg:text-[18px]'>Stay on top of things and revamp your work process with our game-changing feature. Get a  bird&apos;s eye view with our costomizable</p>
        ...
        <div className='flex flex-col gap-x-6 sm:flex-row'>
            ...
            <div className='sm:w-1/2 lg:py-[56px] lg:pl-[56px]'>
                ...
                <p className='py-[24px] text-[$36485C] lg:text-[18px]'>Stay on top of things and revamp your work process with our game-changing feature. Get a  bird&apos;s eye view with our costomizable dashboard.</p>
                 <ul className='flex flex-col gap-y-3 lg:text-[18px]'>
                    <li className='flex items-center gap-x-2 text-[#36485C]'>
                        <span><Image src={Check} alt='Checkmark'/></span>
                        Lorem ipsum dolor sit amet
                 ...
                 <p className='flex items-center gap-x-2 pt-[24px] font-medium text-[#00A424] lg:text-[18px]'>
                    Learn More <span><Image  src={greenButton} alt='bluebutton'/></span>
                 </p>
            </div>
        </div>
        ...
        <div className='flex flex-col gap-x-6 sm:flex-row-reverse'>
            ...
            <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
                ...
                <h1 className='pt-[12px] text-2xl font-medium text-[#172026] lg:text-[42px] lg:leading-[58px]'>Monitor your site&apos;s new subcribers</h1>
                ...
                <p className='py-[24px] text-[#36485C] lg:text-[18px]'>Stay on top of things and revamp your work process with our game-changing feature. Get a  bird&apos;s eye view with our costomizable</p>
                 ...
                 <p className='flex items-center gap-x-2 pt-[24px] font-medium text-[#EB2891] lg:text-[18px]'>
                    Learn More <span><Image  src={pinkButton} alt='bluebutton'/></span>
                 </p>
            </div>
        </div>
